        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    {{Form::label('name', \Lang::get('post.name'), array('class' => 'col-lg-2 control-label'));}}
                    <div class="col-lg-10">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <div class="checkbox">
                            <label>
                                {{Form::checkbox('disabled', 0,null)}} {{\Lang::get('post.publish')}}
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <div class="checkbox">
                            <label>
                                {{Form::checkbox('frontend', 0,null)}} {{\Lang::get('post.frontend')}}
                            </label>
                        </div>
                    </div>
                </div>  
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <div class="checkbox">
                            <label>
                                {{Form::checkbox('frontend', 0,null)}} {{\Lang::get('post.full_page')}}
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('tagsinput', Input::old('tagsinput'), array('id'=>'tagsinput','class'=>'tagsinput')) }}
                    </div>
                </div>
            </div>
            <div class="panel-body">
