        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {{ Form::text('code', $page['item']->code, array('id'=>'code','class'=>'form-control','disabled')) }}
                    </div>
                </div>
                <div class="form-group">
        ...
        <section class="panel">
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        {{\Form::select('project_id', \Project::all()->lists('name', 'id'),$page['item']->project_id, array('class' => 'form-control', 'id' => 'project_id'))}}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('code',  \Lang::get('jproject.required_completion_date'), array('class' => 'col-lg-3 control-label'));}}
                    <div class="col-lg-5">
                        {{ Form::text('required_completion_date', $page['item']->required_completion_date, array('id'=>'required_completion_date','class'=>'form-control')) }}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="controls col-md-9">
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            ...
                            @if($page['item2']!=NULL)
                            <br />
                            <a href="{{\URL::to($page['item2'][0]->url)}}" target="_blank">{{\Lang::get('jproject.download')}}</a>
                            @endif
                        </div>
                    </div>
                </div>
                @if(\User::checkLevel())
                <div class="form-group">
                    <label class="col-lg-3 control-label" for="status">{{\Lang::get('jproject.status')}}</label>                    
                    <div class="col-lg-5">
                        <select name="status" id="project_id" class="form-control">
                            <option value="">{{\Lang::get('jproject.please_select')}}.</option>
                            <option value="1">{{\Lang::get('jproject.cancel')}}</option>
                            <option value="0">{{\Lang::get('jproject.action')}}</option>
                            <option value="2">{{\Lang::get('jproject.success')}}</option>
                        </select>                    
                    </div>
                </div>
                @endif
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::textarea('description', $page['item']->description, array('id'=>'description','class'=>'form-control ckeditor','rows'=>10)) }}
                    </div>
                </div>
            </div>
        </section>
...
@if($page['item2']!=NULL)
{{ Form::hidden('file_id',$page['item2'][0]->id ) }}
@endif
{{ Form::close() }}
@stop
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#code').focus();
        var options = {
            url: base_url + index_page + 'backend/jproject/document/edit/01',
