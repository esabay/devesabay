    ...
    <div class="col-sm-12">
        <section class="panel">
            <div class="panel-body">
                ...
                <button type="button" class="btn btn-primary" id="btnAddSub"><i class="icon-plus"></i> {{\Lang::get('post.add_sub')}}</button>
                @endif
...
<script type="text/javascript">
    $('#btnAdd').click(function() {
        var data = {
            url: 'backend/jorganization/department/add',
    ...
    $('#btnAddSub').click(function() {
        ...
        {
            var data = {
                url: 'backend/jorganization/department/sub/add',
    ...
    $('#btnDelete').click(function() {
        var data = {
            url: 'backend/jorganization/department/delete',
