...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input class="form-control" name="spec1" id="spec1" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec2" class="col-lg-2 control-label">Spec 2</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec2" id="spec2" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec3" class="col-lg-2 control-label">Spec 3</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec3" id="spec3" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec4" class="col-lg-2 control-label">Spec 4</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec4" id="spec4" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec5" class="col-lg-2 control-label">Spec 5</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec5" id="spec5" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec6" class="col-lg-2 control-label">Spec 6</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec6" id="spec6" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec7" class="col-lg-2 control-label">Spec 7</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec7" id="spec7" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec8" class="col-lg-2 control-label">Spec 8</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec8" id="spec8" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec9" class="col-lg-2 control-label">Spec 9</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec9" id="spec9" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec10" class="col-lg-2 control-label">Spec 10</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec10" id="spec10" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec11" class="col-lg-2 control-label">Spec 11</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec11" id="spec11" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec12" class="col-lg-2 control-label">Spec 12</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec12" id="spec12" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec13" class="col-lg-2 control-label">Spec 13</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec13" id="spec13" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec14" class="col-lg-2 control-label">Spec 14</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec14" id="spec14" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec15" class="col-lg-2 control-label">Spec 15</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec15" id="spec15" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec16" class="col-lg-2 control-label">Spec 16</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec16" id="spec16" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec17" class="col-lg-2 control-label">Spec 17</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec17" id="spec17" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec18" class="col-lg-2 control-label">Spec 18</label>
    <div class="col-lg-8"><input class="form-control" name="spec18" id="spec18" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec19" class="col-lg-2 control-label">Spec 19</label>
    <div class="col-lg-8"><input class="form-control" name="spec19" id="spec19" type="text">
    </div>
</div>
<div class="form-group">
    <label for="spec20" class="col-lg-2 control-label">Spec 20</label>
    <div class="col-lg-8">
        <input class="form-control" name="spec20" id="spec20" type="text">
    </div>
</div>
<div class="form-group">
