    ...
    <div class="col-sm-12">
        <section class="panel">
            <div class="panel-body">
                ...
                <button type="button" class="btn" id='btnMoveUp'><i class="icon-arrow-up"></i> Up </button>
                <button type="button" class="btn" id='btnMoveDown'><i class="icon-arrow-down"></i> Down </button>
            </div>
        </section>
    </div>
</div>
        ...
        <section class="panel">
            ...
            <table class="table table-striped border-top" id="sample_1">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            {{Form::radio('id[]', $item['id'],null,array('class'=>'radio-inline checkboxes','id'=>'id'))}} {{$item['title']}} <span class="badge">{{count($item['children'])}}</span>
                        </td>
