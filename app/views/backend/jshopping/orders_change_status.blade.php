...
<div class="form-group">
    <div class="col-lg-12">
        {{ Form::textarea('remark', \Input::old('remark'), array('id'=>'remark','class'=>'form-control','cols'=>50,'rows'=>8,'placeholder'=>\Lang::get('jshopping.remark'))) }}
    </div>
</div>
<div class="form-group">
...
<script type="text/javascript">
    $('#btnDialogSave').click(function() {
        var data = {
            url: 'backend/jshopping/orders/change/status/<?php echo \Request::segment(6); ?>',
