...
<div class="form-group">
    ...
    <div class="col-lg-8">
        {{ Form::text('contact',$page['item']->contact, array('id'=>'contact','class'=>'form-control')) }}
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        {{ Form::textarea('desc',$page['item']->desc, array('id'=>'desc','class'=>'form-control','cols'=>30,'rows'=>3)) }}
    </div>
</div>
<div class="form-group">
