        ...
        <section class="panel">
            <div class="panel-body">
                ...
                <div class="form-actions">
                    <div class="pull-left">
                        <a href="{{URL::to('/backend/jcareer/application')}}" class="btn btn-mini btn-info"><i class="icon-arrow-left"></i> {{\Lang::get('jcareer.back')}}</a>
                    </div>
...
<div class="row">
    ...
    <div class="col-lg-6">
        <section class="panel">
            <header class="panel-heading">
                {{\Lang::get('jcareer.interview_result')}} {{\Lang::get('jcareer.info')}}
                <span class="tools pull-right">
                    <a href="javascript:;" class="icon-chevron-down"></a>                    
                </span>
            </header>
            <div class="panel-body">
                ...
                @foreach(\Careerinterview::where('info_id',\Request::segment(4))->get() as $info)
                @if($info->info!=null)
                <h4>{{\User::getFullName($info->created_user)}}</h4>
                {{$info->info}}
                <hr />
                @endif
                @endforeach
...
<div class="row">
    ...
    <div class="col-lg-6">
        <section class="panel">
            <header class="panel-heading">
                {{\Lang::get('jcareer.interview_result')}} {{\Lang::get('jcareer.occupation')}}
                <span class="tools pull-right">
                    <a href="javascript:;" class="icon-chevron-down"></a>                    
                </span>
            </header>
            <div class="panel-body">
                @foreach(\Careerinterview::where('info_id',\Request::segment(4))->get() as $occupation)
                @if($occupation->occupation!=null)
                <h4>{{\User::getFullName($occupation->created_user)}}</h4>
...
<div class="row">
    ...
    <div class="col-lg-6">
        <section class="panel">
            <header class="panel-heading">
                {{\Lang::get('jcareer.interview_result')}} {{\Lang::get('jcareer.education')}}
                <span class="tools pull-right">
                    <a href="javascript:;" class="icon-chevron-down"></a>                    
                </span>
            </header>
            <div class="panel-body">
                @foreach(\Careerinterview::where('info_id',\Request::segment(4))->get() as $education)
                @if($education->education!=null)
                <h4>{{\User::getFullName($education->created_user)}}</h4>
                {{$education->education}}
                <hr />
                @endif
                @endforeach
...
<div class="row">
    ...
    <div class="col-lg-6">
        <section class="panel">
            <header class="panel-heading">
                {{\Lang::get('jcareer.interview_result')}} {{\Lang::get('jcareer.experience')}}
                <span class="tools pull-right">
                    <a href="javascript:;" class="icon-chevron-down"></a>                    
                </span>
            </header>
            <div class="panel-body">
                @foreach(\Careerinterview::where('info_id',\Request::segment(4))->get() as $experience)
                @if($experience->experience!=null)
                <h4>{{\User::getFullName($experience->created_user)}}</h4>
...
<div class="row">
    ...
    <div class="col-lg-6">
        <section class="panel">
            <header class="panel-heading">
                {{\Lang::get('jcareer.interview_result')}} {{\Lang::get('jcareer.skill_b')}}
                <span class="tools pull-right">
                    <a href="javascript:;" class="icon-chevron-down"></a>
            ...
            <div class="panel-body">
                @foreach(\Careerinterview::where('info_id',\Request::segment(4))->get() as $skill)
                @if($skill->skill!=null)
                <h4>{{\User::getFullName($skill->created_user)}}</h4>
                {{$skill->skill}}
                <hr />
                @endif
                @endforeach
...
<div class="row">
    ...
    <div class="col-lg-6">
        <section class="panel">
            <header class="panel-heading">
                {{\Lang::get('jcareer.interview_result')}} {{\Lang::get('jcareer.other')}}
                <span class="tools pull-right">
                    <a href="javascript:;" class="icon-chevron-down"></a>                    
                </span>
            </header>
            <div class="panel-body">
                @foreach(\Careerinterview::where('info_id',\Request::segment(4))->get() as $other)
                @if($other->other!=null)
                <h4>{{\User::getFullName($other->created_user)}}</h4>
                {{$other->other}}
                <hr />
                @endif
                @endforeach
...
<div class="row">
    ...
    <div class="col-lg-6">
        <section class="panel">
            ...
            <div class="panel-body">
                @foreach(\Careerinterview::where('info_id',\Request::segment(4))->get() as $summary)
                @if($summary->summary!=null)
                <h4>{{\User::getFullName($summary->created_user)}}</h4>
                {{$summary->summary}}
                <hr />
                @endif
                @endforeach
...
<div class="row">
    <div class="col-lg-6">
        <section class="panel">
            <header class="panel-heading">
                {{\Lang::get('jcareer.status')}}
            </header>
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-lg-5">
                        {{Form::select('status',array(
                                    '1' => \Lang::get('jcareer.interview_status_1'),
                                    '2' => \Lang::get('jcareer.interview_status_2'),
                                    '3' => \Lang::get('jcareer.interview_status_3'),
                                    '4' => \Lang::get('jcareer.interview_status_4'),
                                    '5' => \Lang::get('jcareer.interview_status_5'),
                                    '6' => \Lang::get('jcareer.interview_status_6'),
                                    '7' => \Lang::get('jcareer.interview_status_7'),
                                    '8' => \Lang::get('jcareer.interview_status_8'),
                                            ), $page['info']->status,array('class' => 'form-control', 'id' => 'status'))}}
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="col-lg-6">
        <section class="panel">
            ...
            <div class="panel-body">
                @foreach(\Careerinterview::where('info_id',\Request::segment(4))->get() as $item)
...
{{ Form::hidden('info_id', \Request::segment(4)) }}
{{ Form::close() }}
@stop
...
<script type="text/javascript">
    $(function() {
        ...
        var options = {
            url: base_url  + 'backend/jcareer/interview/add',
        ...
        if (response.error.status === false) {
            ...
            setTimeout(function() {
                ...
                $('#myModal').on('hidden.bs.modal', function() {
                    window.location.replace(base_url  + 'backend/jcareer/application');
                });
            }, 3000);
        }
    }
