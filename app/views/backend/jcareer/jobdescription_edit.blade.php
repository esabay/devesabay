        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        {{\Form::select('department_id', array('' => \Lang::get('common.please_select')) +$page['category'], $page['item']->department_id, array('class' => 'form-control', 'id' => 'department_id'))}}
                    </div>
                </div>
            </div>
        </section>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#title').focus();
        var options = {
            url: base_url  + 'backend/jcareer/jobdescription/edit',
