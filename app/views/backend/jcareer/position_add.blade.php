        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        {{\Form::select('department_id', array('' => \Lang::get('common.please_select')) +$page['department'], null, array('class' => 'form-control', 'id' => 'department_id'))}}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('amount', \Lang::get('jcareer.amount'), array('class' => 'col-lg-2 control-label'));}}
                    <div class="col-lg-1">
                        {{ Form::text('amount', Input::old('amount'), array('id'=>'amount','class'=>'form-control')) }}
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        {{ Form::text('salary', Input::old('salary'), array('id'=>'salary','class'=>'form-control')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('place', \Lang::get('jcareer.place'), array('class' => 'col-lg-2 control-label'));}}
                    <div class="col-lg-6">
                        {{ Form::text('place', Input::old('place'), array('id'=>'place','class'=>'form-control')) }}
                    </div>
                </div> 
                <div class="form-group">
                    {{Form::label('job_qualification', \Lang::get('jcareer.job_qualification'), array('class' => 'col-lg-2 control-label'));}}
                    <div class="col-lg-8">
                        {{ Form::textarea('qualification', Input::old('qualification'), array('id'=>'qualification','class' => 'form-control', 'cols' => 50, 'rows' => 10,'style'=>'white-space:pre-wrap;')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('benefit', \Lang::get('jcareer.benefit'), array('class' => 'col-lg-2 control-label'));}}
                    <div class="col-lg-8">
                        {{ Form::textarea('benefit', Input::old('benefit'), array('id'=>'benefit','class' => 'form-control', 'cols' => 50, 'rows' => 10,'style'=>'white-space:pre-wrap;')) }}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('job_description', \Lang::get('jcareer.job_description'), array('class' => 'col-lg-2 control-label'));}}
                    <div class="col-lg-8">
                        {{ Form::textarea('description', Input::old('description'), array('id'=>'description','class' => 'form-control', 'cols' => 50, 'rows' => 15,'style'=>'white-space:pre-wrap;')) }}
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-5">
                        <div class="checkbox">
                            <label>
                                {{Form::checkbox('disabled', 0,null)}} {{\Lang::get('jcareer.publish')}}
                            </label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var options = {
            url: base_url  + 'backend/jcareer/position/add',
